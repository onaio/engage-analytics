...
select
    ...
    -- Process all other columns dynamically
            ...
            CASE
                WHEN EXISTS (
                    SELECT 1 FROM metadata_pii
                    WHERE ("column" = 'patient_age_3' OR linkid = 'patient_age_3' OR short_name = 'patient_age_3')
                    AND anon = 'TRUE'
                )
                THEN
            ...
            CASE
                WHEN EXISTS (
                    SELECT 1 FROM metadata_pii
                    WHERE ("column" = 'patient_biological_sex_2' OR linkid = 'patient_biological_sex_2' OR short_name = 'patient_biological_sex_2')
                    AND anon = 'TRUE'
                )
                THEN
                ...
                ELSE "patient_biological_sex_2"
            END as "patient_biological_sex_2",
            ...
            CASE
                WHEN EXISTS (
                    SELECT 1 FROM metadata_pii
                    WHERE ("column" = 'patient_date_of_birth_3' OR linkid = 'patient_date_of_birth_3' OR short_name = 'patient_date_of_birth_3')
                    AND anon = 'TRUE'
                )
                THEN
                ...
                ELSE "patient_date_of_birth_3"
            END as "patient_date_of_birth_3",
            ...
            CASE
                WHEN EXISTS (
                    SELECT 1 FROM metadata_pii
                    WHERE ("column" = 'patient_gender_identity_2' OR linkid = 'patient_gender_identity_2' OR short_name = 'patient_gender_identity_2')
                    AND anon = 'TRUE'
                )
                THEN
                ...
                ELSE "patient_gender_identity_2"
            END as "patient_gender_identity_2",
            ...
            CASE
                WHEN EXISTS (
                    SELECT 1 FROM metadata_pii
                    WHERE ("column" = 'patient_how_you_think_of_yourself_2' OR linkid = 'patient_how_you_think_of_yourself_2' OR short_name = 'patient_how_you_think_of_yourself_2')
                    AND anon = 'TRUE'
                )
                THEN
                ...
                ELSE "patient_how_you_think_of_yourself_2"
            END as "patient_how_you_think_of_yourself_2",
            ...
            CASE
                WHEN EXISTS (
                    SELECT 1 FROM metadata_pii
                    WHERE ("column" = 'patient_name_3' OR linkid = 'patient_name_3' OR short_name = 'patient_name_3')
                    AND anon = 'TRUE'
                )
                THEN
            ...
            CASE
                WHEN EXISTS (
                    SELECT 1 FROM metadata_pii
                    WHERE ("column" = 'patient_pronouns_2' OR linkid = 'patient_pronouns_2' OR short_name = 'patient_pronouns_2')
                    AND anon = 'TRUE'
                )
                THEN
                ...
                ELSE "patient_pronouns_2"
            END as "patient_pronouns_2",

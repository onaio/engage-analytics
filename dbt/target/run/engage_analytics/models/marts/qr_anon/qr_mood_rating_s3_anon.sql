  ...
  create view "airbyte"."engage_analytics_engage_analytics_mart"."qr_mood_rating_s3_anon__dbt_tmp"
...
from "airbyte"."engage_analytics_engage_analytics_mart"."qr_mood_rating_s3"
  );
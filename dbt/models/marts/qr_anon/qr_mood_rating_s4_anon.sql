...
select
    ...
    qr_id as qr_id,
    mood_rating_ipc_session_4_total_score as mood_rating_ipc_session_4_total_score,
    mood_rating_ipc_session_2_on_a_scale_of_1_to_10_with_1_being__4 as mood_rating_ipc_session_2_on_a_scale_of_1_to_10_with_1_being__4,
    CURRENT_TIMESTAMP as anonymized_at

from {{ ref('qr_mood_rating_s4') }}